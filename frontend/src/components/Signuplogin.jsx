...
function Signuplogin(){
  ...
  <div class="flex flex-col items-center justify-center px-12 py-8 mx-auto md:h-screen lg:py-0">
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-12 w-[450px] space-y-4 md:space-y-6 sm:p-8">
              ...
              <div>
                  ...
                  <button type="submit" class="w-full text-white bg-[#367C57] hover:bg-[#0b3b22] rimary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create an account</button>
